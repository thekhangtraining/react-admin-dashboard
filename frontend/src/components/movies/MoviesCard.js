...
const MoviesCard = ({
  ...
  return (
    <div className="flex flex-col rounded-md overflow-hidden w-56 m-3 bg-zinc-200 shadow-lg hover:scale-105 hover:border-cyan-700 hover:border-2 duration-150">
